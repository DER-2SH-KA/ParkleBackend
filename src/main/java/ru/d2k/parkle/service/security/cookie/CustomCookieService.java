...
public abstract class CustomCookieService {
    ...
    public abstract ResponseCookie createResponseCookie(String name, String value, boolean httpOnly, boolean secure,
                                                        String path, long maxAge, String sameSite);

    public abstract ResponseCookie createEmptyResponseCookie(String name, boolean httpOnly, boolean secure,
