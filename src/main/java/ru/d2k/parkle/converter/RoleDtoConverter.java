...
/**
 * Utility class converter between {@code Role} entity and {@code RoleDto}.
 * **/
public final class RoleDtoConverter {
     ...
     * @param dto {@code RoleDto}.
     * @return {@code Role} entity with null ID.
     * **/
     ...
     * @param entity {@code Role} entity to edit.
     * @param dto {@code RoleDto}.
     * @return Edited {@code Role} entity.
     * **/
