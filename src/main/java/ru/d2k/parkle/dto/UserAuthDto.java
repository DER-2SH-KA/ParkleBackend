...
public class UserAuthDto implements UserDto {
    ...
    @Size(min = 3, max = 50, message = "UserAuthDto login length must be between 3 and 50 symbols")
    ...
    @Size(min = 8, max = 72, message = "UserAuthDto password lengths must be between 8 and 72 symbols")
