...
public class UserUpdateDtoTest {
    ...
    public void shouldBeTrueWhenValidationObjectsHasCorrectFieldsValues(UserUpdateDto dto, String description) {
        ...
        Assertions.assertTrue(violations.isEmpty(), "Violation in scenario '" + description + "': " +
                violations);
    }
    ...
    public void shouldBeFalseWhenValidationObjectsHasWrongFieldsValues(UserUpdateDto dto, String description) {
        ...
        Assertions.assertFalse(violations.isEmpty(), "Violation in scenario '" + description + "': " +
                violations);
    }
    ...
    private static Stream<Arguments> shouldBeTrueWhenValidationObjectsHasCorrectFieldsValues() {
        char[] maxRoleNameChars = new char[32];
        char[] lowMinLoginChars = new char[3];
        char[] maxLoginChars = new char[50];
        char[] maxEmailChars = new char[312];
        char[] maxPasswordChars = new char[72];
        ...
        String maxRoleName = new String(maxRoleNameChars);
        String lowMinLogin = new String(lowMinLoginChars);
        String maxLogin = new String(maxLoginChars);
        String maxEmail = new String(maxEmailChars) + "@mail.ru";
        String maxPassword = new String(maxPasswordChars);
    ...
    private static Stream<Arguments> shouldBeFalseWhenValidationObjectsHasWrongFieldsValues() {
        char[] overMaxRoleNameChars = new char[33];
        char[] lowerMinLoginChars = new char[2];
        char[] overMaxLoginChars = new char[51];
        ...
        String overMaxRoleName = new String(overMaxRoleNameChars);
        String lowerMinLogin = new String(lowerMinLoginChars);
